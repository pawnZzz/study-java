...
//            sum += tokens(encoding, msg.getName());
    ...
    public static void main(String[] args) {
        ...
        message.setContent("给我讲一个笑话");

        Message message2 = new Message();
        message2.setRole(Message.Role.ASSISTANT.getName());
        message2.setContent("有一个鸟儿又聪明又勇敢，它飞过了一个漆黑的山洞。在洞口，有两只蝙蝠正交叉地挂在洞壁上，两者之间隔着一块大石头。\\n\\n鸟儿：“两位大仙，请问这里是哪里？”\\n\\n一只蝙蝠：“这里是蝙蝠洞。”\\n\\n鸟儿：“哦，我还以为是鸟巢呢。”\\n\\n另一只蝙蝠：“你这个笨鸟，我们蝙蝠洞里怎么会有鸟巢？”\\n\\n鸟儿：“我还以为是鸟巢，因为中间有两个笨蝙蝠挂在鸟巢里，还缺一块石头呢。”");
        System.out.println(tokens("gpt-3.5-turbo", Lists.newArrayList(message2)));
    }
}
